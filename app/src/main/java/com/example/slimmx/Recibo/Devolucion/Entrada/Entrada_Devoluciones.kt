package com.example.slimmx.Recibo.Devolucion.Entrada
...
class Entrada_Devoluciones : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_entrada_devoluciones)
    ...
    private fun actualizarcbBox(opciones: List<String>) {
        try {
            ...
            MensajesDialog.showMessage(this@Entrada_Devoluciones, "Ocurrió un error: ${e.message}");
        }
        ...
        try {
            ...
            lifecycleScope.launch {
                Pedir_datos_apis_post(
                    ...
                    onError = { error ->
                        MensajesDialog.showMessage(this@Entrada_Devoluciones, "Error: $error");
                        btn_confirmar.isEnabled=true;
                    }
                )
            }
                    ...
                    Pedir_datos_apis(
                        ...
                        onSuccess = { lista ->
                            lifecycleScope.launch(Dispatchers.Main) {
                                if (lista.isEmpty()) {
                                    val intent = Intent(this@Entrada_Devoluciones, Seleccion_devolucion::class.java)
                            ...
                            lifecycleScope.launch(Dispatchers.Main) {
                                MensajesDialog.showMessage(this@Entrada_Devoluciones, "${error}");
                            }
                        }
                    )
                }catch (e: Exception) {
    ...
    override fun onBackPressed() {
        ...
        //LogsEntradaSalida.logsPorModulo( this, lifecycleScope, "DEVOLUCION/ENTRADA", "SALIDA");
        finish();
    }
