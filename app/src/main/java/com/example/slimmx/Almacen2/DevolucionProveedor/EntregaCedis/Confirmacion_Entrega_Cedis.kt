package com.example.slimmx.Almacen2.DevolucionProveedor.EntregaCedis
...
class Confirmacion_Entrega_Cedis : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_confirmacion_entrega_cedis)
        ...
        btn_confirmar.setOnClickListener {
            AlertDialog.Builder(this)
                ...
                .setPositiveButton("Sí") { _, _ ->
                    try {
                        confirmacion(this@Confirmacion_Entrega_Cedis.id_devolucion,txtFolioDevolucion.text.toString())
                    }catch (e: Exception){
                        MensajesDialog.showMessage(this@Confirmacion_Entrega_Cedis, "Ocurrió un error: ${e.message}");
                    }
            ...
            try {
                ...
                lifecycleScope.launch(Dispatchers.IO) {
                    try{
                        Pedir_datos_apis(
                            ...
                            onSuccess = { lista ->
                                lifecycleScope.launch(Dispatchers.Main) {
                                    if (lista.isNotEmpty()) {
                                        ...
                                        this@Confirmacion_Entrega_Cedis.id_devolucion = datos.ID
                            ...
                            onError = { error ->
                                lifecycleScope.launch(Dispatchers.Main) {
                                    MensajesDialog.showMessage(this@Confirmacion_Entrega_Cedis, "Error: $error")
                                }
                            }
                        )
                    }catch (e: Exception) {
                ...
                lifecycleScope.launch(Dispatchers.Main) {
                    MensajesDialog.showMessage(
                        this@Confirmacion_Entrega_Cedis,
            ...
            try {
                ...
                lifecycleScope.launch {
                    Pedir_datos_apis_post(
                        endpoint = "/confirmar/recibo/almacen/pdvi",
                        body = body,
                        listaKey = "message",
                        dataClass = Any::class,
                        headers=headers,
                        onSuccess = { lista ->
                            if (lista.toString().contains("EL PRODUCTO FUE RECIBIDO CORRECTAMENTE")) {
                                MensajesDialogConfirmaciones.showMessage(this@Confirmacion_Entrega_Cedis, "Confirmado correctamente") {
                                    ...
                                    actualizarTableLayout(items);
                                    txtFolio.setText("");
                                    this@Confirmacion_Entrega_Cedis.id_devolucion=0;
                                }
                        ...
                        onError = { error ->
                            ...
                            MensajesDialog.showMessage(this@Confirmacion_Entrega_Cedis, " $mensajeError");
                        }
